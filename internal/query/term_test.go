	...
	var testCases = []testCase{
		{
			name:  "TestTerm01",
			input: `"dsada 78"`,
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`}}}},
		},
		{
			name:  "TestTerm02",
			input: `"dsada 78"^08`,
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`, Boost: "^08"}}}},
		},
		{
			name:  "TestTerm03",
			input: `"dsada 78"~8`,
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`, Fuzzy: "~8"}}}},
		},
		{
			name:  "TestTerm04",
			input: `"dsada 78"~8^080`,
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`, Fuzzy: "~8", Boost: "^080"}}}},
		},
		{
			name:  "TestTerm05",
			input: `/dsada 78/`,
		...
		},
		{
			...
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{SimpleTerm: &SimpleTerm{Value: []string{`\/dsada\/\ dasda80980`, `?`, `*`}}}}},
		},
		{
			name:  "TestTerm07",
			input: `\/dsada\/\ dasda80980?*\^\^^08`,
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{SimpleTerm: &SimpleTerm{Value: []string{`\/dsada\/\ dasda80980`, `?`, `*`, `\^\^`}, Boost: `^08`}}}},
		},
		{
			name:  "TestTerm08",
			input: `\/dsada\/\ dasda80980?*\^\^~8`,
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{SimpleTerm: &SimpleTerm{Value: []string{`\/dsada\/\ dasda80980`, `?`, `*`, `\^\^`}, Fuzzy: `~8`}}}},
		},
		{
			name:  "TestTerm09",
			input: `\/dsada\/\ dasda80980?*\^\^~8^080`,
			want:  &Term{ComSymTerm: &ComSymTerm{Term: &CompTerm{SimpleTerm: &SimpleTerm{Value: []string{`\/dsada\/\ dasda80980`, `?`, `*`, `\^\^`}, Fuzzy: `~8`, Boost: `^080`}}}},
		},
		{
			name:  "TestTerm10",
			input: `[1 TO 2]`,
		...
		},
		{
			name:  "TestTerm17",
			input: `<="dsada 78"`,
			want:  &Term{ComSymTerm: &ComSymTerm{Sym: "<=", Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`}}}},
		},
		{
			name:  "TestTerm18",
			input: `<"dsada 78"^08`,
			want:  &Term{ComSymTerm: &ComSymTerm{Sym: "<", Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`, Boost: "^08"}}}},
		},
		{
			name:  "TestTerm19",
			input: `>="dsada 78"~8`,
			want:  &Term{ComSymTerm: &ComSymTerm{Sym: ">=", Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`, Fuzzy: "~8"}}}},
		},
		{
			name:  "TestTerm20",
			input: `>"dsada 78"~8^080`,
			want:  &Term{ComSymTerm: &ComSymTerm{Sym: ">", Term: &CompTerm{PhraseTerm: &PhraseTerm{Value: `"dsada 78"`, Fuzzy: "~8", Boost: "^080"}}}},
		},
	}
